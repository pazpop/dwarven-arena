...
public static class HazardRegistry
{
    ...
    private static void ResetOnPlay() => Colliders.Clear();

    public static void Register(Collider2D col) => Colliders.Add(col);
    public static void Unregister(Collider2D col) => Colliders.Remove(col);
}
